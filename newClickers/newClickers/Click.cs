...
namespace newClickers
{
    class Click : ICommand
    {
        public void Run()
        {
            ClickerGame.points += ClickerGame.pointsPerClick;
